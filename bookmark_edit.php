...
$sql = 'SELECT * FROM ' . $xoopsDB->prefix('xf_user_bookmarks') . " WHERE bookmark_id='" . $bookmark_id . "' AND user_id='" . $xoopsUser->getVar('uid') . "'";
...
?>
    <form method="post">
        ...
        <p>
            ...
            <input type="text" name="bookmark_title" value="<?php echo $ts->htmlSpecialChars($bookmark_title); ?>">
        <p>
